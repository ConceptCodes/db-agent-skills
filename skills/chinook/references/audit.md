...
Re-run `python3 skills/chinook/scripts/audit_chinook.py` rather than assuming these facts still hold after the file changes.
...
- `PRAGMA foreign_keys` is `0` on a new connection. Enable it explicitly before authorized writes.
